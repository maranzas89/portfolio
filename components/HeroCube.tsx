...
export default function HeroCube() {
  return (
    <div className="relative z-20 flex items-center justify-center w-[420px] h-[420px] shrink-0 min-w-[320px] min-h-[320px] max-w-[420px] max-h-[420px] translate-y-[-15px] md:translate-y-[80px]">

...
export default function PageHero({
  ...
  return (
    <header
      className={`relative overflow-hidden text-white border-b border-white/20 flex flex-col ${backgroundVariant === "ai-explorations" ? "" : "min-h-[580px] md:min-h-[640px]"} ${className}`}
      style={{
            ...
            <div className="min-w-0 flex-1">
              ...
              {hasCtas && (
                <div className="flex flex-wrap gap-4 mt-8">
                  ...
                  {secondaryCta && (secondaryCta.href?.includes("William_Liu_Resume") ? (
                    ...
                    <a
                      ...
                      download={secondaryCta.download === true ? "William_Liu_Resume.pdf" : secondaryCta.download || undefined}
                      target="_blank"

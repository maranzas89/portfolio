...
export default function SignupModal({ open, onClose, onSwitchToLogin }: SignupModalProps) {
  ...
  return (
    ...
    >
      ...
      {/* Modal */}
      <div
        className="relative w-full max-w-[960px] min-h-[620px] bg-white rounded-2xl shadow-2xl overflow-hidden flex mx-4"
      ...
      >
        ...
        <div className="flex-1 flex flex-col justify-center px-10 md:px-16 py-12">
          ...
          <label className="flex items-center gap-2.5 mt-6 cursor-pointer select-none">
            <input
              ...
              className="w-4 h-4 accent-[#e2752c] rounded"
            />
        ...
        {/* Right — Promo Panel */}
        <div className="hidden md:flex w-[420px] bg-[#b8e6fb] flex-col items-center justify-between px-10 py-10 rounded-l-3xl shrink-0">
          {/* Logo */}
